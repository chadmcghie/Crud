...
Use the file-creator subagent to create directory: docs/03-Development/specs/YYYY-MM-DD-spec-name/ using the date from step 4.
...
<spec_sections>
  <technical_requirements>
    ...
    - Application layer changes (use cases, DTOs, interfaces)
    - Infrastructure layer changes (repositories, external services)
    - Presentation layer changes (controllers, API endpoints, UI components)
...
<schema_sections>
  <changes>
    ...
    - new tables/columns (Infrastructure layer)

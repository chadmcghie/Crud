...
test.describe('Authenticated Routes', () => {
  ...
  test.skip('@critical can access people list when authenticated', async ({ page }) => {
  ...
  test.skip('@critical can access admin routes when authenticated as admin', async ({ page, authHelper }) => {
    // Login as admin
  ...
  test.skip('@critical redirects to login when not authenticated', async ({ page, authHelper }) => {
  ...
  test.skip('@critical shows unauthorized page for non-admin users', async ({ page, authHelper }) => {

...
template_dir=".agents/.agent-os/templates"
...
write_info "\nTest 2: Template File Loading"
template_files=(
    ".agents/.agent-os/templates/backend/crud-feature.md"
    ".agents/.agent-os/templates/backend/api-endpoint.md"
    ".agents/.agent-os/templates/backend/domain-aggregate.md"
    ".agents/.agent-os/templates/frontend/angular-component.md"
    ".agents/.agent-os/templates/frontend/angular-service.md"
    ".agents/.agent-os/templates/frontend/angular-state.md"
)
...
create_tasks_file=".agents/.agent-os/instructions/core/create-tasks.md"

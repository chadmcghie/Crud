...
class StatusAggregator {
  constructor(specsDir = '.agents/.agent-os/specs') {
    this.specsDir = specsDir;
    this.statusDir = '.agents/.agent-os/status';
...
- **View Specs**: Browse [.agents/.agent-os/specs/](./../specs/)
- **Check Roadmap**: View [.agents/.agent-os/roadmap.md](./../roadmap.md)

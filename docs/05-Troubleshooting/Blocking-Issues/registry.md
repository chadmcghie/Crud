...
|---|---|---|---|---|---|
| BI-2025-09-23-001 | 2025-09-23 | troubleshoot-integration-test-blockers | test | Integration test HTTP 409 Conflict authentication failures - 60 tests failing due to parallel user registration conflicts | high |
